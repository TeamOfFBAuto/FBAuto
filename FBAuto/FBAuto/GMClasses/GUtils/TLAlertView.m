...
- (void)show {
    ...
    [UIView animateWithDuration:kPresentationAnimationDuration delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        self.frame = CGRectMake(CGRectGetMinX(self.viewToShowIn.frame) + 24, CGRectGetMidY(self.viewToShowIn.frame) - 155, CGRectGetWidth(self.viewToShowIn.frame) - 50, 160);
    }                completion:nil];
